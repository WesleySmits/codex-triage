...
- Validation uses synthetic tests and read-only local browser interactions. No real Jev call, Codex archive or restore, deployment, or publication is needed to prove this documentation change.
